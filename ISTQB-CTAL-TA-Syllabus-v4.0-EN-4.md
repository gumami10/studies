...
2025/05/02 Major update with overall revision and scope update

2022/01/31 Errata: Minor formatting, grammar, and wording defects fixed
2021/05/15 Errata: The copyright notice has been adapted to the current ISTQB®

standards

v3.1

2021/03/03 Minor update with section 3.2.3 rewritten and various wording improvements
...
1 The Tasks of the Test Analyst in the Test Process – 225
...
(K2) Summarize the involvement of the test analyst in various software development
lifecycles

1.2 Involvement in Test Activities
TA-1.2.1

(K2) Summarize the tasks performed by the test analyst as part of test analysis
...
(K2) Summarize the tasks performed by the test analyst as part of test design

(K2) Summarize the tasks performed by the test analyst as part of test implementation

(K2) Summarize the tasks performed by the test analyst as part of test execution

1.3 Tasks Related to Work Products
TA-1.3.1

(K2) Differentiate between high-level test cases and low-level test cases
...
(K2) Explain the quality criteria for test cases

(K2) Give examples of test environment requirements

(K2) Explain the test oracle problem and potential solutions

(K2) Give examples of test data requirements

(K3) Use keyword-driven testing to develop test scripts

(K2) Summarize the types of tools to manage the testware
...
In addition to these tasks, the TA defines the test environment requirements (see Section 1.3.3) and
...
and test automation (see Section 2.2).
...
• Requirement management tools to contain and track high-level requirements, ensuring these are
...
2 The Tasks of the Test Analyst in Risk-Based Testing – 90
...
(K2) Summarize the test analyst’s contribution to product risk analysis

2.2 Risk Control
TA-2.2.1

(K4) Analyze the impact of changes to determine the scope of regression testing
...
(K3) Apply domain testing

(K3) Apply combinatorial testing

(K2) Summarize the benefits and limitations of random testing
...
(K2) Explain CRUD testing

(K3) Apply state transition testing

(K3) Apply scenario-based testing
...
(K3) Apply decision table testing

(K3) Apply metamorphic testing
...
(K3) Prepare test charters for session-based testing

(K3) Prepare checklists that support experience-based testing

(K2) Give examples of the benefits and limitations of crowd testing
...
(K4) Select appropriate test techniques to mitigate product risks for a given situation

(K2) Explain the benefits and risks of automating the test design
...
(K2) Differentiate between functional correctness, functional appropriateness, and
...
(K2) Explain how the test analyst contributes to usability testing

4.3 Flexibility Testing

TA-4.3.1

(K2) Explain how the test analyst contributes to adaptability and installability testing

4.4 Compatibility Testing

TA-4.4.1

(K2) Explain how the test analyst contributes to interoperability testing
...
(K2) Explain how the test analyst can contribute to defect prevention
...
(K3) Use a model of the test object to detect defects in a specification

(K3) Apply a review technique to a test basis to find defects
...
(K4) Analyze test results to identify potential improvements to defect detection

(K2) Explain how defect classification supports root cause analysis
...
Software Technology. Vol. 127, p. 106363. Available from doi: 10.1016/j.infsof.2020.106363.
...
on Software Reliability Engineering, pp. 269–279. isbn 0-7695-1763-3. Available from doi: 10.1109/
ISSRE.2002.1173268.
...
Available from doi: 10.1109/TSE.2011.121.
...
pp. 507–525. Available from doi: 10.1109/TSE.2014.2372785.
...
Software testing and analysis, pp. 109–124. Available from doi: 10.1145/186258.187153.
...
Vol. 152, pp. 165–181. Available from doi: 10.1016/j.jss.2019.03.002.

CHILLAREGE, R. et al., 1992. Orthogonal Defect Classification - A Concept for In-Process Measurements.
IEEE Transactions on Software Engineering. Vol. 18, pp. 943–956. Available from doi: 10 . 1109 / 32 .
177364.

CHOW, Tsun, 1978. Testing Software Design Modeled by Finite-State Machines. IEEE Transactions on

Software Engineering. Vol. 4, pp. 178–187. Available from doi: 10.1109/TSE.1978.231496.
...
Engineering, pp. 303–309. isbn 0-8186-6665-X. Available from doi: 10.1109/ISSRE.1994.341392.

ENGSTRÖM, Emelie; RUNESON, Per; SKOGLUND, Mats, 2010. A systematic review on regression test
selection techniques. Information and Software Technology. Vol. 52, pp. 14–30. Available from doi:
...
Programming. XP 2017. isbn 978-3-319-57632-9. Available from doi: 10.1007/978-3-319-57633-6_17.

HAREL, David, 1987. Statecharts: A Visual Formalism For Complex Systems. Science of Computer

Programming. Vol. 8, pp. 231–274. Available from doi: 10.1016/0167-6423(87)90035-9.
...
Available from doi: 10.1109/TSE.2019.2942921.

JENG, Bingchiang; WEYUKER, Elaine, 1994. A Simplified Domain-Testing Strategy. ACM Transactions
on Software Engineering and Methodology. Vol. 3, pp. 254–270. Available from doi: 10.1145/196092.
193171.
...
Testing. IEEE Transactions on Software Engineering. Vol. 30, pp. 418–421. Available from doi: 10.1109/
TSE.2004.24.
...
Software Testing. IEEE Software. Vol. 34, pp. 62–69. Available from doi: 10.1109/MS.2017.37.
...
7 Appendix A – Learning Objectives/Cognitive Level of
...
Use keyword-driven testing to develop test scripts
...
Can be used in a LO that wants the candidate to
...
Support and perform appropriate testing based on the software development lifecycle
followed
...
Select and apply appropriate test techniques to support the achievement of test
objectives
...
Summarize the involvement of the test analyst in various software development
lifecycles (K2)
...
Summarize the tasks performed by the test analyst as part of test analysis (K2)

TA-1.2.2

Summarize the tasks performed by the test analyst as part of test design (K2)

TA-1.2.3

Summarize the tasks performed by the test analyst as part of test implementation (K2)

TA-1.2.4

Summarize the tasks performed by the test analyst as part of test execution (K2)
...
Differentiate between high-level test cases and low-level test cases (K2)

TA-1.3.2

Explain the quality criteria for test cases (K2)

TA-1.3.3

Give examples of test environment requirements (K2)

TA-1.3.4

Explain the test oracle problem and potential solutions (K2)

TA-1.3.5

Give examples of test data requirements (K2)

TA-1.3.6

Use keyword-driven testing to develop test scripts (K3)

TA-1.3.7

Summarize the types of tools to manage the testware (K2)
...
Summarize the test analyst’s contribution to product risk analysis (K2)
...
Analyze the impact of changes to determine the scope of regression testing (K4)
...
Apply domain testing (K3)

TA-3.1.2

Apply combinatorial testing (K3)

TA-3.1.3

Summarize the benefits and limitations of random testing (K2)
...
Explain CRUD testing (K2)

TA-3.2.2

Apply state transition testing (K3)

TA-3.2.3

Apply scenario-based testing (K3)
...
Apply decision table testing (K3)

TA-3.3.2

Apply metamorphic testing (K3)
...
Prepare test charters for session-based testing (K3)

TA-3.4.2

Prepare checklists that support experience-based testing (K3)
...
Give examples of the benefits and limitations of crowd testing (K2)
...
Select appropriate test techniques to mitigate product risks for a given situation (K4)

✕ ✕

TA-3.5.2

Explain the benefits and risks of automating the test design (K2)
...
Differentiate between functional correctness, functional appropriateness, and functional
...
Explain how the test analyst contributes to usability testing (K2)
...
Explain how the test analyst contributes to adaptability and installability testing (K2)
...
Explain how the test analyst contributes to interoperability testing (K2)
...
Explain how the test analyst can contribute to defect prevention (K2)
...
Use a model of the test object to detect defects in a specification (K3)
...
Apply a review technique to a test basis to find defects (K3)
...
Analyze test results to identify potential improvements to defect detection (K4)

TA-5.3.2

Explain how defect classification supports root cause analysis (K2)
...
A matrix that indicates the action types of the functions on the entities within a
system.

data semantics

The meaning and interpretation of data.
...
An approach to identify problem areas or tasks that will have the biggest payoff.

user journey map

User experience visualization documentation that shows the steps that a user takes
in a process to accomplish a goal.

user research

A discipline of learning about users’ needs and thought processes by studying how
...
decision table testing, 28, 35

defect arrival pattern, 53
...
risk monitoring, 24, 26

risk-based test selection, 26
