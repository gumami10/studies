<template>
  <header>
    <h1>ISTQB CTAL-TAE Study Guide</h1>
    <p class="subtitle">Advanced Level Test Automation Engineering (v2.0) — Chapter-by-Chapter Review</p>
    <AppNav />
  </header>
...
onMounted(() => {
  store.setKey('ctal-tae-highlights')
